...
const STATIC_VOCABULARY: Record<string, WordPair[]> = {
  'Animals': [
    ...
    { english: 'Bird', kadazan: 'Tombolog', malay: 'Burung', example: 'Tumulud ih tombolog.', exampleEnglish: 'The bird flies.', exampleMalay: 'Burung itu terbang.', category: 'Animals', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Buceros_rhinoceros_-Houston_Zoo-8a.jpg/800px-Buceros_rhinoceros_-Houston_Zoo-8a.jpg' },
